...
class RolServiceTest {
    ...
    void asignar_datosValidos_usuarioRolTieneDatosCorrectos() {
        ...
        assertNotNull(guardado.getAssignedAt());
    }
    ...
    void quitar_usuarioConDosRoles_eliminaCorrectamente() {
        ...
        when(usuarioRolRepository.countByUsuario_UsuarioId(1))
                .thenReturn(2L);
    ...
    void quitar_rolQueNoTiene_lanzaExcepcion() {
        ...
        when(usuarioRolRepository.existsByUsuario_UsuarioIdAndRol_Nombre(1, "VENDEDOR"))
                .thenReturn(false);
